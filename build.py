...
<link rel="preload" href="https://fonts.googleapis.com/css2?family=Oswald:wght@500;600;700&family=Inter:wght@400;500;600&family=Shippori+Mincho:wght@600;700&display=swap" as="style" onload="this.onload=null;this.rel='stylesheet'">
<noscript><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Oswald:wght@500;600;700&family=Inter:wght@400;500;600&family=Shippori+Mincho:wght@600;700&display=swap"></noscript>
<link rel="canonical" href="https://parmakendokai.it/{canonical}">
<meta property="og:title" content="{title}">
<meta property="og:description" content="{description}">
<meta property="og:type" content="website">
<meta property="og:image" content="{prefix}images/hero-dojo.webp">
<meta property="og:locale" content="it_IT">
<meta name="twitter:card" content="summary_large_image">
<meta name="theme-color" content="#0a0907">
<script type="application/ld+json">{{"@context":"https://schema.org","@type":"SportsClub","name":"Parma Kendo Kai","url":"https://parmakendokai.it","address":{{"@type":"PostalAddress","streetAddress":"Via San Leonardo 191a","addressLocality":"Parma","addressCountry":"IT"}},"geo":{{"@type":"GeoCoordinates","latitude":44.801485,"longitude":10.327904}},"email":"parmakendokai@libero.it","telephone":"+39 349 159 5885"}}</script>
...
<header class="site-header">
  <div class="max-w-6xl mx-auto px-5 md:px-8 flex items-center justify-between h-16">
    <a class="flex items-center gap-3" href="{prefix}index.html">
      <img loading="lazy" decoding="async" src="{prefix}images/tiger-logo-icon.webp" alt="Stemma Parma Kendo Kai" class="h-10 w-10 rounded-full shrink-0 border border-dojo-orange/40">
...
<div class="lightbox" id="lightbox" hidden role="dialog" aria-modal="false" aria-label="Anteprima immagine">
...
def write_page(rel_path, title, description, content, hero="", current_href=None, extra_scripts=""):
    ...
    canonical = rel_path if rel_path != "index.html" else ""
    html = (
        HEAD.format(title=title, description=description, prefix=prefix, tw_config=TAILWIND_CONFIG, canonical=canonical)
...
<div class="hero">
  <div class="hero-bg" aria-hidden="true">
    <img src="images/hero-dojo.webp" alt="Dojo Parma Kendo Kai" width="1920" height="1080" fetchpriority="high" decoding="async">
    <img class="hero-tiger" src="images/tiger-logo.webp" alt="" width="560" height="560" loading="lazy" decoding="async">
  ...
  <div class="hero-content relative max-w-6xl mx-auto px-5 md:px-8 w-full">
    ...
    <h1 class="font-display text-[11vw] sm:text-6xl md:text-7xl leading-[0.95] text-paper mb-6 max-w-3xl" style="text-wrap:balance">
...
<figure class="pkk-figure my-9">
  <img loading="lazy" decoding="async" src="{prefix}images/chi-siamo-1.webp" alt="Praticanti in armatura durante un keiko">
</figure>
...
<figure class="pkk-figure my-9">
  <img loading="lazy" decoding="async" src="{prefix}images/chi-siamo-2.webp" alt="Allenamento di gruppo alla Parma Kendo Kai">
</figure>
...
<figure class="pkk-figure my-9">
  <img loading="lazy" decoding="async" src="{prefix}images/chi-siamo-3.webp" alt="Momento di pratica in coppia">
</figure>
...
<figure class="pkk-figure my-9">
  <img loading="lazy" decoding="async" src="{prefix}images/chi-siamo-4.webp" alt="Praticanti della Parma Kendo Kai in posa">
</figure>
...
<div class="gallery-grid grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-1.5 mb-4">
  <img loading="lazy" decoding="async" src="{prefix}images/galleria-1.webp" alt="Foto di gruppo, allenamento 1" class="aspect-[4/3] object-cover w-full">
  <img loading="lazy" decoding="async" src="{prefix}images/galleria-2.webp" alt="Foto di gruppo, allenamento 2" class="aspect-[4/3] object-cover w-full">
  <img loading="lazy" decoding="async" src="{prefix}images/galleria-3.webp" alt="Foto di gruppo, allenamento 3" class="aspect-[4/3] object-cover w-full">
  <img loading="lazy" decoding="async" src="{prefix}images/galleria-4.webp" alt="Foto di gruppo, allenamento 4" class="aspect-[4/3] object-cover w-full">
  <img loading="lazy" decoding="async" src="{prefix}images/galleria-5.webp" alt="Foto di gruppo, allenamento 5" class="aspect-[4/3] object-cover w-full">
  <img loading="lazy" decoding="async" src="{prefix}images/galleria-6.webp" alt="Foto di gruppo, allenamento 6" class="aspect-[4/3] object-cover w-full">
</div>
</div>
...
<figure class="pkk-figure my-2 mb-10">
  <img loading="lazy" decoding="async" src="{prefix}images/bambini-1.webp" alt="Bambini durante un allenamento di Kendo">
</figure>
...
<div class="gallery-grid grid grid-cols-2 gap-2 my-9 not-prose">
  <img loading="lazy" decoding="async" src="{prefix}images/bambini-2.webp" alt="Allenamento bambini 1" class="aspect-[4/3] object-cover w-full">
  <img loading="lazy" decoding="async" src="{prefix}images/bambini-3.webp" alt="Allenamento bambini 2" class="aspect-[4/3] object-cover w-full">
</div>
...
<figure class="pkk-figure mb-10">
  <img loading="lazy" decoding="async" src="{prefix}images/conan-hero.webp" alt="Immagine di gruppo Conan Cup">
</figure>
...
<figure class="pkk-figure mb-10">
  <img loading="lazy" decoding="async" src="{prefix}images/conan-maglietta.webp" alt="Maglietta ufficiale Conan Cup">
</figure>
...
<figure class="pkk-figure mb-10">
  <img loading="lazy" decoding="async" src="{prefix}images/conan-2024-risultati.webp" alt="Tabellone risultati Conan Cup 2024">
</figure>
...
<figure class="pkk-figure mb-10">
  <img loading="lazy" decoding="async" src="{prefix}images/conan-2023-gruppo.webp" alt="Foto di gruppo, partecipanti Conan Cup 2023">
...
<figure class="pkk-figure mb-10">
  <img loading="lazy" decoding="async" src="{prefix}images/dove-1.webp" alt="Ingresso della palestra Aiki Center">
</figure>
...
<figure class="pkk-figure mb-10">
  <img loading="lazy" decoding="async" src="{prefix}images/locandina.webp" alt="Locandina Parma Kendo Kai">
</figure>
...
<form class="not-prose grid gap-4" action="https://formspree.io/f/INSERISCI_QUI_ID_FORMSPREE" method="POST">
  <input type="hidden" name="_subject" value="Richiesta info da parmakendokai.it">
...
<figure class="pkk-figure mb-10">
  <img loading="lazy" decoding="async" src="{prefix}images/hakama-gi.webp" alt="Esempio di hakama e gi">
...
<div class="gallery-grid grid grid-cols-2 gap-2 my-9 not-prose">
  <img loading="lazy" decoding="async" src="{prefix}images/shinai.webp" alt="Esempio di shinai" class="aspect-square object-cover w-full">
  <img loading="lazy" decoding="async" src="{prefix}images/bokken.webp" alt="Esempio di bokken" class="aspect-square object-cover w-full">
</div>
...
<figure class="pkk-figure mb-10">
  <img loading="lazy" decoding="async" src="{prefix}images/bogu.webp" alt="Esempio di bogu, l'armatura da Kendo">
</figure>
...
<div class="not-prose mt-10 flex flex-wrap gap-3">
  <a class="hero-cta-primary font-display px-7 py-3.5 text-sm tracking-wide" href="{prefix}modulistica.html">Scarica il modulo di iscrizione</a>
  <a class="hero-cta-ghost font-display px-7 py-3.5 text-sm tracking-wide" href="{prefix}contatti-info/come-iniziare.html">Prenota prova gratuita</a>
</div>
""" + CONTAINER_CLOSE
...
# 404
write_page("404.html", "Pagina non trovata | Parma Kendo Kai", "La pagina richiesta non esiste.", page_banner("404 – Pagina non trovata", "Forse hai seguito un link vecchio. Torna alla home.", "迷子") + CONTAINER_OPEN + '<p>La risorsa richiesta non esiste. Torna alla <a href="{prefix}index.html">home</a>.</p>' + CONTAINER_CLOSE)

# sitemap + robots
import datetime
pages = ["index.html","corso-bambini.html","principi-del-kendo.html","modulistica.html","conan-cup.html","codice-condotta.html","galleria.html","privacy.html","cookie-policy.html","contatti-info/dove-quando.html","contatti-info/come-iniziare.html","contatti-info/costi.html","contatti-info/risorse.html"]
today = datetime.date.today().isoformat()
sitemap = '<?xml version="1.0" encoding="UTF-8"?>\n<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">\n' + "\n".join(f'  <url><loc>https://parmakendokai.it/{p}</loc><lastmod>{today}</lastmod></url>' for p in pages) + '\n</urlset>'
open(os.path.join(ROOT,"sitemap.xml"),"w",encoding="utf-8").write(sitemap)
open(os.path.join(ROOT,"robots.txt"),"w",encoding="utf-8").write("User-agent: *\nAllow: /\nSitemap: https://parmakendokai.it/sitemap.xml\n")
